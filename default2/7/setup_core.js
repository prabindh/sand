...
function tutorialObj(context3d, x, y, program, objectParams)
{
	...
	****************************************************************/
	function create_text()
	{
		...
		div1.id = "text-box";
		div1.textContent = "GPU";
		
		div3 = document.createElement('div');
		div3.id = "text-box";
		div3.textContent = "Powered.Org";

		div2 = document.createElement('div');
		div2.id = "Top-2d-Activity";
		div4 = document.getElementById("Target-OpenGL-view");
	...
	function delete_text()
	{
		...
		div4.removeChild(div2);
	}
	function update_text()
	{
		var width2 = environParams.canvasWidth/2;
		var height2 = environParams.canvasHeight/2;
		div1.style.left = (width2 + Math.random()*height2)+'px';
		div1.style.top = (width2 + Math.random()*height2)+'px';
		div3.style.left = (width2 + Math.random()*height2)+'px';
		div3.style.top = (width2 + Math.random()*height2)+'px';
		div1.style.fontSize = Math.random()*64+"px";
		div3.style.fontSize = Math.random()*44+"px";	
	}
