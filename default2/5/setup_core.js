...
function check_known_object(object)
{
	...
	if(object == "x-axis") return true;	
	if(object == "y-axis") return true;	
	if(object == "z-axis") return true;		
	return false;
}	
...
function retrieve_blob_data(objectName)
{
	...
	offscreenViewportWidth = 256;
	offscreenViewportHeight = 256;
