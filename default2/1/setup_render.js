	...
	{	
		...
		{		
			var loadedVal = load_grid_data();//load_border_data();
				...
				angleX, angleY, angleZ, locX, locY, locZ)
	{
		...
		matrix1.perspective(55, environparams.canvasWidth/environparams.canvasHeight, 0.1, 50);		
		
		var newAngle = (angleY + objParams.angleY) % 90;
		matrix1.rotate(newAngle, 0,1,0);
